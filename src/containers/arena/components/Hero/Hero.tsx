...
const Hero: React.FC<HeroProps> = ({}) => {
  ...
  return (
    <div className="relative h-[310px] bg-cosmon-main-quaternary lg:h-[380px]">
      {/* DESKTOP */}
      ...
      {/* MOBILE */}
      <div className="flex h-full items-center justify-center px-[30px] lg:hidden">
        <Slider showNavigationButtons={false}>
          <div
            style={{
              position: 'relative',
              background: 'url(/mea-bg-outline.png) top left no-repeat',
